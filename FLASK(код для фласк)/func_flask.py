...
def get_closer_metro_info(list_all):
    ...
    for i in tqdm(list_all):
           ...
           # res_ind = sorted(res).index(res[0])
...
def get_dots_all_info(new_coords_list, list_all):
    ...
    for i in tqdm(new_coords_list):
        ...
        dist_to_closer_metro_aprise = 'good' if dist_metro/1.2 < dist_to_closer_metro_mean else 'bad'
        ...
        vaq2 = {'coordinates': i,
                ...
                'chisl_before_conquer_apprise': chisl_apprise,
                'status': status,
                'date_start_statistic': '09.02.2021', 'latitude': i[0], 'longitude': i[1],
                'chisl' : population_before_conq, 'category':categ
                }
...
def get_itog_dots_list_with_options(list):
    ...
    itog_dots_point = []
    for i in tqdm(list):
        if i['chisl_before_conquer_apprise'] == 'good' and i['dist_to_conquer_aprise'] == 'good' and i[
            'dist_to_closer_metro_aprise'] == 'good':
        # if i['chisl_before_conquer_apprise'] == 'good' and i['dist_to_conquer_aprise'] == 'good':
            itog_dots.append(i)
