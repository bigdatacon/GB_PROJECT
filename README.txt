...
Дополнительно: добавлены файлы 5-6) Sending, для интернет сервсива который на вход получает широту и долготу точки, а на выходе экселевские файлы с данными. Без установки локального сервера все можно проверить в файле 5.Sending
